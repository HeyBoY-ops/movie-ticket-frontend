...
// import { Moon, Sun, MapPin, User } from "lucide-react";
...
//   return (
//     <nav
//       className={`relative w-full flex items-center justify-between px-6 py-4 shadow-md  top-0 z-50 ${
...
//         <h1
//           onClick={() => navigate("/")}
//           className="text-2xl font-bold text-[#ff004c] cursor-pointer"
//         >
//           Escape Room 🎬
//         </h1>
...
//           className={`px-4 py-2 rounded-lg w-full max-w-md focus:outline-none focus:ring-2 focus:ring-[#ff004c] ${
//             darkMode
...
//             }
//             className={`border rounded px-2 py-1 w-24 text-sm focus:outline-none ${
//               darkMode
...
//           className="w-9 h-9 flex items-center justify-center rounded-full bg-[#ff004c] hover:bg-[#e60045] transition"
//         >
//           <User size={20} />
//         </button>
//       </div>
...
//         <div
//           ref={sidebarRef}
//           className={`absolute top-16 right-4 w-72 ${
//             darkMode ? "bg-zinc-900 text-white" : "bg-white text-gray-900"
...
//                 <button
//                   onClick={logout}
//                   className="mt-4 w-full bg-[#ff004c] py-2 rounded-lg font-semibold hover:bg-[#e60045] transition"
//                 >
//                   Logout
//                 </button>
//               </>
...
//                   className="bg-[#ff004c] w-full py-2 rounded-lg font-semibold hover:bg-[#e60045] transition"
//                 >
//                   Login / Signup
//                 </button>
//               </div>
